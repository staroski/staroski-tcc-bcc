...
public interface ClientSession extends Connection {
     ...
     *
     * @param auth the <code>Authenticator</code> to use for this connection
     *
     * @exception NullPointerException if <code>auth</code> is <code>null</code>
     */
     ...
     *
     * @exception IllegalArgumentException if <code>headers</code> was not
     * created by a call to <code>createHeaderSet()</code>
     */
     ...
     *
     * @exception IllegalArgumentException if <code>headers</code> were not
     * created by a call to <code>createHeaderSet()</code>
     */
     ...
     *
     * @param backup if <code>true</code>, instructs the server to back up one
     ...
     * current directory
     *
     * @param create if <code>true</code>, instructs the server to  create the
     * directory if it does not exist; if <code>false</code>, instruct the server
